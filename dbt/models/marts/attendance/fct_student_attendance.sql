...
with student_attendance as (
    ...
    left join {{ ref('stg_edfi_students') }} students
        on ssa.school_reference.school_year = students.school_year
    ...
    left join {{ ref('stg_edfi_calendar_dates') }} calendar_dates
        on ssa.school_reference.school_year = calendar_dates.calendar_reference.school_year
    ...
    left join {{ ref('stg_edfi_student_school_attendance_events') }} school_attendance
        on ssa.school_reference.school_year = school_attendance.session_reference.school_year
        ...
        and (
            ssa.school_reference.school_year is null
            or 
            school_attendance.session_reference.school_year = ssa.school_reference.school_year
        )
    ...
    left join{{ ref('stg_edfi_student_section_attendance_events') }} section_attendance
        on ssa.school_reference.school_year = section_attendance.section_reference.school_year
    ...
    left join {{ ref('stg_edfi_student_section_associations') }} student_section_associations
        on section_attendance.section_reference.school_year = student_section_associations.section_reference.school_year
    ...
    group by
        ...
        schools.local_education_agency_id,
        ssa.school_reference.school_id,
        ssa.school_reference.school_year,
        calendar_dates.date,
